...
export class GameService {
    ...
    async updateTeamConnectionStatus(code: string, team: string, clientId: string): Promise<Game> {
    ...
    async updateTeamDisconnectStatus(code: string, team: string, clientId: string): Promise<Game> {
        const game = await this.findOneGame(code);
