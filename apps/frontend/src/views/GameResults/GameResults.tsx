...
export const GameResults: React.FC<GameResultsProps> = ({ team }) => {
  ...
  return (
    <div className={styles.pageResults}>
      <img
        src="/assets/asset-bg-results.svg"
        alt=""
      ...
      <div className={styles.content}>
        <div className={styles.headingsContainer}>
          ...
          <h2 className="titlePage">
            <span className={styles.winner}>{teamName}</span> est l’équipe
            gagnante.
          </h2>
        </div>
        <img
          src="/assets/asset-winner.svg"
          alt=""
          className={styles.winnerAsset}
        />
        <div className={styles.score}>
          <div className={clsx(styles.scoreContainer, styles.scoreTeam1)}>
            <div
              className={clsx(styles.team, styles.team1, 'heading heading-s')}
            >
              Équipe 1
            </div>
          ...
          <div className={clsx(styles.scoreContainer, styles.scoreTeam1)}>
            <div
              className={clsx(styles.team, styles.team2, 'heading heading-s')}
            >
              Équipe 2
            </div>
            <div className={styles.scoreDetails}>
